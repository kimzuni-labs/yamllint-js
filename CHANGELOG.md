...
* add `yamllint-js` command and remove support rc files ([#32](https://github.com/kimzuni-labs/yamllint-js/issues/32)) ([1a07976](https://github.com/kimzuni-labs/yamllint-js/commit/1a079766ef81c9aaa00d0dcb5e6ba045109e1809))
